...
def upload():
	...
	if request.method == 'POST':
		...
		print("this the result array we need to show ", prediction)
		pred1 = prediction[0]
		print("presdfasdf", pred1)
		pred_ar = np.array(pred1)
		pred_idx = np.argmax(pred_ar)
		#print("jsdhflahdjfalkdjfdaslfjahldjf", predicted_class)
		predicted_class = classes['TRAIN'][pred_idx]
